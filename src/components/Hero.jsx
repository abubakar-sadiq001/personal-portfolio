  ...
  return (
    ...
    <div className="bg-img mt-5 flex h-[400px] justify-center">
      <div className="flex flex-col items-center justify-center">
        <h1 id="heading" className="text-7xl text-white">
          Hi👋, I'm Sdik
        </h1>
        ...
        <p className="para mt-3 w-full max-w-[500px] text-center text-[18px] text-gray-400">
          A passionate and self taught front-end enginner,
        </p>
        <p className="para mt-1 w-full max-w-[500px] text-center text-[18px] text-gray-400">
